  ...
  init: function () {
    ...
    if (i !== -1) {
      S.UI.simulate(decodeURI(action).substring(i + 3));
        ...
        S.UI.simulate('|#countdown 3|某某|小盆友|生日快乐！|Happy Birthday!|❤️|福星高照迎新岁|春暖花开庆生辰|愿君|千般皆如意|万事定称心|不必万丈光芒|但愿始终|温暖有光|最后|送上我最最最|真诚的祝福|祝你|一站有一站的风景|一岁有一岁的味道|花会沿途盛开|以后的路也是|嘿嘿❤️❤️|');
    }
